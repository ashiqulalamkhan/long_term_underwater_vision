...
def registration_histogram(source, target, params):
    ...
    if params.hist == True:
        ...
        plt.savefig("result/"+params.hist_name, dpi=600)
        plt.show()
        ...
        plt.yscale("log")
        plt.savefig("result/"+params.hist_name + "_log", dpi=600)
        plt.show()
...
class Params:
    def __init__(self, source_dir="/home/turin/Desktop/lizard_dataset_curated/2015/pcd15.pcd",
                 ...
                 hist_bins=1000, hist_name = "Registration Error Histogram"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hist_name", type=str, default="Registration Error Histogram", help="Histogram Name")
